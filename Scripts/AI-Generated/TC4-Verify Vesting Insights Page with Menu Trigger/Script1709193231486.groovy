...
"Step 10: Click on button 'menu-trigger-coins-vesting-controls-platforms'"

WebUI.takeScreenshot()

WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_insights_vesting/button_menu_trigger_coins_vesting_controls_platfor'), 20, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/insights/vesting?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_insights_vesting/button_menu_trigger_coins_vesting_controls_platfor'))

"Step 11: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC4-Verify Vesting Insights Page with Menu Trigger_visual_checkpoint')
