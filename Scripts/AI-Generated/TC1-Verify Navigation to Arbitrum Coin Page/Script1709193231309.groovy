...
"Step 8: Click on link '8\nADA\nCardano' -> Navigate to page 'coins/altlayer && coins/cardano'"
...
WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_coins_altlayer /hyperlink_token_unlocks'), 20, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/coins/altlayer && coins/cardano?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_coins_altlayer /hyperlink_token_unlocks'))

"Step 10: Click on link 'SKL\nSKALE' -> Navigate to page 'coins/skale/vesting'"

WebUI.takeScreenshot()

WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_insights_vesting/hyperlink_skl_skale'), 20, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/insights/vesting?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_insights_vesting/hyperlink_skl_skale'))

"Step 11: Click on button 'Search\n/' -> Navigate to page 'coins/arbitrum'"

WebUI.takeScreenshot()

WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_coins_skale_vesting/button_search'), 20, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/coins/skale/vesting?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_coins_skale_vesting/button_search'))

"Step 12: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC1-Verify Navigation to Arbitrum Coin Page_visual_checkpoint')
