...
"Step 9: Click on link 'coin-tabs-item-fundraising' -> Navigate to page 'coins/altlayer/fundraising'"

WebUI.takeScreenshot()

WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_coins_cardano /hyperlink_coin_tabs_item_fundraising'), 20, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/coins/cardano && coins/altlayer?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_coins_cardano /hyperlink_coin_tabs_item_fundraising'))

"Step 10: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC6-Verify Altlayer Fundraising Page Functionality_visual_checkpoint')
