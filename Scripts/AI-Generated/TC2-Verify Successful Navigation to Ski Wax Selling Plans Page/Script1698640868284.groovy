...
'step 2: At Page home click on hyperlink headermenu home'

testObj = findTestObject('Object Repository/Page_home/hyperlink_headermenu_home')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC2-Verify Successful Navigation to Ski Wax Selling Plans Page_visual_checkpoint')
